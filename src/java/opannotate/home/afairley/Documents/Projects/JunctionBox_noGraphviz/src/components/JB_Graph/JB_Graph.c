               ...
               :}
               :
               :void EdgeMap_Add(EdgeMap *this, Edge *e){ /* EdgeMap_Add total:      2  0.1647 */
               :  Map_Element *me = jballoc(sizeof(Map_Element));
     1  0.0824 :  me->id = Edge_GetSrcSink(e);
               :  me->contents =e;
     1  0.0824 :  Map_Add(this, me);
               :}
               :
               ...
               :  this->elim_set = es;
               :}
               :void *Edge_GetElimSet(Edge *this){ /* Edge_GetElimSet total:      2  0.1647 */
     1  0.0824 :  return this->elim_set;
     1  0.0824 :}
               :
               ...
               :}
               :
               :Vertex *NeighborItr_Advance(NeighborItr *this){ /* NeighborItr_Advance total:      1  0.0824 */
               :  if(this->curIn == NULL){
               :    if(this->curOut == NULL)
               :      return NULL;
               :    else{
               ...
               :  }
               :  else{
     1  0.0824 :    this->curIn = this->curIn->next ;
               ...
               :  return ret;
               :}
               :char *srcsink(char *src, char *sink){ /* srcsink total:      1  0.0824 */
               :  char *ret = jballoc( (strlen(src)+strlen(sink) +2)*sizeof(char));
               :  ret[0] = (char)0;
     1  0.0824 :  strcat(ret, src);
               :  strcat(ret, " ");
               :  strcat(ret, sink);
               :  return ret;
               :}
               :Edge *Graph_AddEdge(Graph *g, Vertex *src, Vertex *sink ){ /* Graph_AddEdge total:      1  0.0824 */
               :  Edge *ret =Graph_GetEdge(g, src,sink );
     1  0.0824 :  if(ret == NULL){
               :    g->graph_dirty = TRUE; 
               ...
               :
/* 
 * Total samples for file : "/home/afairley/Documents/Projects/JunctionBox_noGraphviz/src/components/JB_Graph/JB_Graph.c"
 * 
 *      7  0.5766
 */
